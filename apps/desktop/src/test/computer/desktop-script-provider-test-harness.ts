...
import type { DesktopScriptRuntimeHost } from '../../../../../runtime/computer/desktop-script-runtime-host'
...
export async function createDesktopScriptProviderClient(
  ...
  const { DesktopScriptProviderClient } = await import('../../../../../runtime/computer/desktop-script-provider-client')
...
export function sampleCapabilities(actions: Partial<Record<string, boolean>> = {}) {
  return {
    platform: 'linux',
    provider: 'osd-computer-use-linux',
