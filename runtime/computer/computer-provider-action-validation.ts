...
import { validateComputerClipboardPasteText } from './computer-clipboard-paste-validation'
...
function validatePasteText(params: Record<string, unknown>): void {
  validateComputerClipboardPasteText(requireNonEmptyString(params, 'text'))
}
