...
import { windowsPowerShellPath } from './process'
...
export class DesktopScriptRuntimeHost {
   ...
   * even on a clean start failure, because the bundled runtime.ps1 can be an
   * older one, left by a partial update, that simply never announces.
   */
