...
export type ComputerSnapshotData = {
  ...
  treeText: string
  elementCount: number
  /** macOS only: this read is the one that switched Chromium's accessibility
   *  tree on for the app, so the tree it returned may still be the stub. */
  manualAccessibilityJustEnabled?: boolean
